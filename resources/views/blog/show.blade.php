        ...
        <div class="flex blog-post">
            <div class="w-full lg:w-3/5 mx-auto">
                ...
                <div class="blog-post-social text-center mt-12">
                    <h6 class="font-semibold italic">¡Comparte!</h6>
                    <div class="flex items-center justify-center">
                        ...
                        <a href="https://twitter.com/intent/tweet?text={{ route('blog.show', ['id' => $post->id, 'slug' => $post->getSlug()]) }}" target="_blank" class="px-4 py-2 rounded text-white mx-2" style="background-color: #25d366;"><i class="fab fa-whatsapp fa-fw"></i></a>
                        <a href="whatsapp://send?text={{ route('blog.show', ['id' => $post->id, 'slug' => $post->getSlug()]) }}" target="_blank" class="px-4 py-2 rounded text-white mx-2" style="background-color: #55acee;"><i class="fab fa-twitter fa-fw"></i></a>
